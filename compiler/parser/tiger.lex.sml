       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"_"
                  then yyQ62(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ62(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyAction59(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction33(strm, yyNO_MATCH)
                      else yyQ62(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction33(strm, yyNO_MATCH)
                  else yyQ62(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction34(strm, yyNO_MATCH)
                      else yyQ62(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ62(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction31(strm, yyNO_MATCH)
                      else yyQ62(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction31(strm, yyNO_MATCH)
                  else yyQ62(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ93(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"l"
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ101(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp < #"k"
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ62(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ100(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ62(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyAction59(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction28(strm, yyNO_MATCH)
                      else yyQ62(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction28(strm, yyNO_MATCH)
                  else yyQ62(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ105(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ62(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ104(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ62(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyAction59(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ103(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ62(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ102(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ62(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ107(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
       ...
       of NONE => yyAction17(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp = #" "
                  then yyQ7(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp < #" "
                  then if inp = #"\v"
                      then yyAction17(strm, yyNO_MATCH)
                    else if inp < #"\v"
                      then if inp <= #"\b"
                          then yyAction17(strm, yyNO_MATCH)
                          else yyQ7(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                    else if inp = #"\r"
                      then yyQ7(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                  ...
                  then if inp = #"!"
                      then yyAction17(strm, yyNO_MATCH)
                      else yyQ8(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp <= #"/"
                  then yyAction17(strm, yyNO_MATCH)
                  else yyQ9(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp = #"f"
              then yyQ7(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp < #"f"
              then if inp = #"]"
                  ...
                  then if inp = #"\\"
                      then yyQ10(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                      else yyAction17(strm, yyNO_MATCH)
                else if inp = #"^"
