...
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm;
      (if !nestedComment>1 then () else YYBEGIN INITIAL;
...
fun yyAction7 (strm, lastMatch : yymatch) = (yystrm := strm;
      (s := ""; inString:=true; strStart := yypos; YYBEGIN STRING; continue()))
fun yyAction8 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; inString:=false; Tokens.STRING(!s, !strStart, yypos)))
...
fun yyAction15 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm; (s := !s ^ (numToChar yytext); continue())
      end
...
fun yyAction18 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (YYBEGIN STRING; (lineNum := !lineNum+ (linesInStr yytext); continue()))
      end
fun yyAction19 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; (ErrorMsg.error yypos ("Must only contain space characters"); continue())))
fun yyAction20 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (lineNum := !lineNum+ (linesInStr yytext); continue())
      end
fun yyAction21 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("illegal whitespace character " ^ yytext); continue())
      end
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"_"
                  then yyQ66(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction30(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction30(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction31(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction31(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction24(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ66(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction34(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ78(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction37(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction37(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction38(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction38(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction26(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction26(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction27(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction27(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction33(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction33(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction23(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction23(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction28(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction28(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction36(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction36(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction25(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction25(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ66(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ104(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ66(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
              else yyAction63(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction32(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction32(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ108(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ66(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
              else yyAction63(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ45 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ112(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
...
fun yyQ114 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction62(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ114(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ41 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ115(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
...
fun yyQ31 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction64(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              then yyQ30(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"\^N"
              ...
              then if inp = #"\v"
                  ...
                  then if inp <= #"\b"
                      then yyAction20(strm, yyNO_MATCH)
                      else yyQ25(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                else if inp = #"\r"
       ...
       of NONE => yyAction14(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"]"
              ...
              then if inp = #"0"
                  then yyQ9(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
                else if inp < #"0"
                  then if inp = #"\""
                  ...
                  then yyQ10(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
                  else yyAction14(strm, yyNO_MATCH)
            else if inp = #"o"
              then yyAction14(strm, yyNO_MATCH)
            else if inp < #"o"
              ...
              then yyQ13(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
              else yyAction14(strm, yyNO_MATCH)
      (* end case *))
